...
/* Show the volume growth for the company. 
...
/* Next, showcase all of efficiency improvements. Show quarterly
figures since the company launched for session-to-order conversion rate, revenue per order,
...
nonbrand, brand search overall, overall search, and direct type-in?
*/
...
/*Next, let's show the overall session to order conversion rate trends for the same channels
...
5. We've come a long way since the days of selling a single product.
 Extract the monthly trending for revenue and margin by product along with total sales amd revenue. Note anything you notice about seasonality.
*/
...
6. Let's dive deeper into the impact of introducing new products.
 Extract the monthly sessions to the /products page, and show how the % of those sessions
 clicking through another page has changed over time along with a view of how 
conversion from /products to placing order has improved.
*/
...
cross-sell item), pull sales data since then, and show how well each product cross-sells from 
one another.
*/
